...
Beyond our Vibe Coding Reproducibility challenge, we also welcome authors to document experiences in attempting to reproduce papers presented at previous AAAI conferences (Main Track) and papers that have been published in the Journal of Artificial Intelligence Research (JAIR), or other academic AI/ML venues. Such works are most influential and useful when they document insights and difficulties in reproduction, what worked well, and distil their knowledge into a realization that may be applicable to other papers in the future. 
